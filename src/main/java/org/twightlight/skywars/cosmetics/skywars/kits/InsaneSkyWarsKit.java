...
public class InsaneSkyWarsKit extends SkyWarsKit {
    ...
    public InsaneSkyWarsKit(int id, String name, CosmeticRarity rarity, String permission, ItemStack icon, int coins, ItemStack[] armor, ItemStack[] content, List<PotionEffect> potions) {
    ...
    public static final Logger LOGGER = SkyWars.LOGGER.getModule("InsaneKits");
