...
public class ConfirmSprayMenu extends PlayerMenu {

    private static final ConfigMenu config = ConfigMenu.getByName("confirmbuy");
    private static final ConfigMenu config1 = ConfigMenu.getByName("spray");
    ...
    public ConfirmSprayMenu(Player player, Cosmetic cosmetic, Class<?> returns, Order order, Filter filter, String searchQuery) {
