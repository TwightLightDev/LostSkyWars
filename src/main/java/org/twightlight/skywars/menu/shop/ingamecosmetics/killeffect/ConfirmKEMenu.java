...
public class ConfirmKEMenu extends PlayerMenu {

    private static final ConfigMenu config = ConfigMenu.getByName("confirmbuy");
    private static final ConfigMenu config1 = ConfigMenu.getByName("killeffect");
    ...
    public ConfirmKEMenu(Player player, Cosmetic cosmetic, Class<?> returns, Order order, Filter filter, String searchQuery) {
