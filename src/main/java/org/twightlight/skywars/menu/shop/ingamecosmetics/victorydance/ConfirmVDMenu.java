...
public class ConfirmVDMenu extends PlayerMenu {

    private static final ConfigMenu config = ConfigMenu.getByName("confirmbuy");
    private static final ConfigMenu config1 = ConfigMenu.getByName("victorydance");
    ...
    public ConfirmVDMenu(Player player, Cosmetic cosmetic, Class<?> returns, Order order, Filter filter, String searchQuery) {
