...
public class User {
    ...
    public User(Player p) {
        ...
        DecentHologramsIntegration.loadStatus.thenApply((b) -> {
            loadLeaderboards();
            return b;
        });
    }
    ...
    public void switchLeaderboards(Leaderboard.Mode mode) {
        ...
        DecentHologramsIntegration.getLeaderboards(viewingMode).forEach(leaderboard -> leaderboard.hide(this));
        DecentHologramsIntegration.getLeaderboards(mode).forEach(leaderboard -> leaderboard.show(this));
    ...
    public void loadLeaderboards() {
        ...
        DecentHologramsIntegration.getLeaderboards().forEach(leaderboard -> leaderboard.hide(this));

        DecentHologramsIntegration.getLeaderboards(viewingMode).forEach(leaderboard -> leaderboard.show(this));
    }
}
