package org.twightlight.skywars.integration.citizens.npc;
...
import static org.twightlight.skywars.integration.citizens.CitizensIntegration.LOGGER;
...
public class ShopkeeperNPC {
    ...
    public void spawn() {
        ...
        this.npc = CitizensIntegration.getRegistry().createNPC(wither == null ? EntityType.SKELETON : wither, "");
