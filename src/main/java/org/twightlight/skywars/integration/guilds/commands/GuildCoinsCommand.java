...
public class GuildCoinsCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                GuildsIntegration.getLanguage().getList("guilds.donation.help.coins").forEach(line -> player.sendMessage(ChatColor.translateAlternateColorCodes('&', line)));
                return true;
            }
