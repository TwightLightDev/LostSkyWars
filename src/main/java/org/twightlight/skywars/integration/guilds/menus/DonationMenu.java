package org.twightlight.skywars.integration.guilds.menus;
...
import org.twightlight.skywars.integration.guilds.menus.api.GMenu;
import org.twightlight.skywars.integration.guilds.menus.api.Item;
...
public class DonationMenu {
    ...
    public static void open(Donator donator) {
        ...
        Item level = new Item((e) -> {
            ...
            material = XMaterial.valueOf(GuildsIntegration.getLevelConfig().getString("level."+ levelStr +".material", "DIAMOND"));
