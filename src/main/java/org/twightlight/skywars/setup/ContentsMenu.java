...
public class ContentsMenu extends Menu{
    ...
    private ContentsMenu(ConfigUtils config, Consumer<Player> backAction, String contentsPath) {
        super(54, false);

        this.config = config;
        this.contentsPath = contentsPath;
        this.contents = config.getStringList(contentsPath).stream().map(BukkitUtils::fullyDeserializeItemStack).collect(Collectors.toList());
    ...
    public static Menu init(ConfigUtils config, Consumer<Player> backAction, String contentsPath) {
