package org.twightlight.skywars.hook.decenthologram.holograms;
...
public class Leaderboard {
    ...
    public Leaderboard(String hologramId, Mode mode) {
        ...
        if (hologram != null) {
            ...
            DecentHologramsHook.getLogger().log(Logger.Level.INFO, "Hologram id " + hologramId + " loaded!");
        }
        else {
            DecentHologramsHook.getLogger().log(Logger.Level.SEVERE, "Hologram id " + hologramId + " not exist. Please manually create it!");
        }
