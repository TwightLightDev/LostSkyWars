...
public class Core {
    ...
    public static final String[] menusArray = new String[]{"profile", "leveling", "statistics", "settings", "shop", "cells", "play", "playduels", "playranked", "kitsandperks",
            ...
            "mysteryvault", "confirmvault", "nperks", "iperks", "rperks", "deliveryman", "deathcry", "balloon", "statsnpc", "symbol", "projectiletrail", "killmessage"};
    public static final List<String> filesSaved = Arrays.asList("profile", "leveling", "statistics", "settings", "shop", "cells", "play", "playduels", "playranked", "kitsandperks",
            "nkits", "ikits", "rkits", "viewkit", "confirmbuy", "kitselector", "mapselector", "well", "wellsettings", "wellharvest", "wellupgrades", "wellroll", "teleporter",
            "mysteryvault", "confirmvault", "nperks", "iperks", "rperks", "deliveryman", "deathcry", "projectiletrail", "killmessage", "balloon", "statsnpc", "symbol", "normalkits", "insanekits", "rankedkits",
            "balloons", "cages", "chesttypes", "deathcries", "projectiletrails", "killmessages", "deliveries", "levels", "perks", "ranked", "ranks", "symbols", "lang");
