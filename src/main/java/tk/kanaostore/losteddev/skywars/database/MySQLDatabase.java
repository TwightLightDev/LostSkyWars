...
public class MySQLDatabase extends Database {
    ...
    private void createSkyWarsTable() {
        this.update("CREATE TABLE IF NOT EXISTS premium_lostedskywars (" + "id VARCHAR(36) NOT NULL," + "name VARCHAR(32) NOT NULL," + "solokills INTEGER NOT NULL,"
                ...
                + "cages TEXT DEFAULT NULL," + "deathcry TEXT DEFAULT NULL," + "trail TEXT DEFAULT NULL," + "ballons TEXT DEFAULT NULL," + "killmessage TEXT DEFAULT NULL," + "selected TEXT DEFAULT NULL," + "lastSelected LONG," + "favorites TEXT,"
                + "PRIMARY KEY(id)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin;");
    }
