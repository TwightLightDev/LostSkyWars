package tk.kanaostore.losteddev.skywars.menu.shop.visual_cosmetics.balloon;
...
public class ConfirmBalloonMenu extends PlayerMenu {
    ...
    public ConfirmBalloonMenu(Player player, Cosmetic cosmetic, Class<?> returns, Order order, Filter filter, String searchQuery) {
