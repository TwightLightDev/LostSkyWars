...
public class ConfirmKMMenu extends PlayerMenu {
    ...
    public ConfirmKMMenu(Player player, Cosmetic cosmetic, Class<?> returns, Order order, Filter filter, String searchQuery) {
