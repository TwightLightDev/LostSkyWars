...
import tk.kanaostore.losteddev.skywars.utils.*;
...
public class SkyWarsTrail extends Cosmetic {
    ...
    public SkyWarsTrail(int id, String name, ItemStack icon, CosmeticRarity rarity,
    ...
    public static void setupProjectileTrails() {
        for (String key : CONFIG.getKeys(false)) {
            ...
            SkyWarsTrail trail = new SkyWarsTrail(id, name, icon, rarity, buyable, price, consumer);
